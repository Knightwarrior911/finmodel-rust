...
2. Financial snapshot: `get_financials` for 3 years of revenue, operating income, net income, diluted EPS; compute growth and margins. `get_quote` for current price and market context.
