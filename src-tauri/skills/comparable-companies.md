...
3. For valuation multiples, pull current prices with `get_quote` and reported financials with `get_financials`; spread EV/EBITDA, EV/Revenue, and P/E. Be explicit about the period (LTM vs. last fiscal year) and keep it consistent across the set.
